...
Terse, lowercase-leaning, developer-direct. Sentence case for UI; the brand wordmark is lowercase (`alt-tv-rewind`). Short imperative buttons ("Sign in", "Post"). Example good: "No posts yet — be the first." Avoid: marketing fluff, exclamation marks, ALL-CAPS, emoji in UI.
